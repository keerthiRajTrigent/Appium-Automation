 ...
 * </p>
 */
public class CustomReport extends Base implements IReporter {
    ...
    private static String outFilename = "Automation-results.html";
    ...
    public void generateReport(List<XmlSuite> xmlSuites, List<ISuite> suites,
        ...
        writer.close();
       try {
    	   String send_eMail = CONFIG.getProperty("Send_eMail");
    	   //System.out.println("Send Mail Config ==> " + send_eMail);
    	   if(send_eMail.equalsIgnoreCase("Yes")){
			Utility.sendmail();
    	   }
		} catch (Exception e) {
			e.printStackTrace();
